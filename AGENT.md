...
- [ ] **待用户拍板**：① CC BY 4.0 是否纳入依赖白名单（决定 SongFormer 去留）；② 知识 002「副歌全踩人声」在 160 首代理实测下仍只降级存疑（人声曲副歌人声领先 7/261，但人声点缀 36%），需用户听审裁定；③ 人声侧结构的下一步：**LRC 歌词时间轴路线已证伪**（note 045：97/109 首找到 LRC，但游戏剪辑版与原曲对不齐、跨曲阴性对照分不开真假；纯音频句读特征对 note 级无效、小节级 R² 中位仅 +0.005）——剩两条路：拿到原曲完整音频做"游戏版×原曲"音频对齐后再用 LRC，或人工听审 5–10 首人声曲标注乐句边界，是否投入
